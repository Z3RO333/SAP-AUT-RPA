...
def _thread_safe_chooser(root: tk.Tk, sessions: list) -> str | None:
    """Schedule pick_session on the Tkinter main thread and block the caller."""
        ...
        try:
            result = run_job(
                {"orders": orders},
                {
                    ...
                    "interactive": True,
                    "session_chooser": lambda sessions: _thread_safe_chooser(self.root, sessions),
                },
                {
